...
<strong>clang/LLVM</strong>: VS 2019 Update 1 includes integration support for clang for Windows using [CMake](https://devblogs.microsoft.com/cppblog/visual-studio-cmake-support-clang-llvm-cmake-3-14-vcpkg-and-performance-improvements/) as an 'individual component'. For details, see [this blog post](https://devblogs.microsoft.com/cppblog/clang-llvm-support-in-visual-studio/). For VS 2019 Update 1, this is [clang 7](releases.llvm.org/7.0.0/tools/clang/docs/ReleaseNotes.html).
