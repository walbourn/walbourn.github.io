...
<strong>Xbox:</strong> The Xbox One version of DirectXMath in the XDK and ADK includes the majority optimizations discussed in this series as Xbox One supports SSE3, SSSE3, SSE4.1, SSE4.2, AVX, and F16C. [Xbox Series X](https://www.xbox.com/en-US/project-scarlett) supports all these plus AVX2 and FMA3.
